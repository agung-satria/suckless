...
const char *spcmd2[] = {"alacritty", "--class", "spcalc", "-e" , "bc", "-lq", NULL };
const char *spcmd3[] = {"alacritty", "--class", "spncmpcpp", "-e", "ncmpcpp", NULL };
const char *spcmd4[] = {"alacritty", "--class", "spcalcurse", "-e", "calcurse", NULL };
const char *spcmd5[] = {"alacritty", "--class", "spnmtui", "-e", "nmtui", NULL };
const char *spcmd6[] = {"alacritty", "--class", "spranger", "-e", "ranger", NULL };
...
static Key keys[] = {
    ...
    { 0, XF86XK_AudioMute,  	     spawn, SHCMD("amixer -q -D pulse sset Master toggle && pkill -RTMIN+8 dwmblocks") },
    { 0, XF86XK_AudioRaiseVolume,    spawn, SHCMD("amixer -q -D pulse sset Master 5%+ && pkill -RTMIN+8 dwmblocks") },
    { 0, XF86XK_AudioLowerVolume,    spawn, SHCMD("amixer -q -D pulse sset Master 5%- && pkill -RTMIN+8 dwmblocks") },
    { 0, XF86MonBrightnessUp,        spawn, SHCMD("brightness-setter +5") },
    { 0, XF86MonBrightnessDown,      spawn, SHCMD("brightness-setter -5") },
    // allow boost
    { MODKEY,			        XK_0,		    spawn,		SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle && pkill -RTMIN+8 dwmblocks") },
    { MODKEY,			        XK_equal,		spawn,		SHCMD("pactl set-sink-volume 0 +5% && pkill -RTMIN+8 dwmblocks") },
    { MODKEY,			        XK_minus,		spawn,		SHCMD("pactl set-sink-volume 0 -5% && pkill -RTMIN+8 dwmblocks") },
    ...
    { MODKEY|ShiftMask,		  XK_apostrophe,    spawn,	    SHCMD("gnome-calculator") },
    ...
    // { MODKEY,			        XK_F4,		      spawn,		SHCMD(TERMINAL "st -c float-st-pulsemixer -g 100x25 pulsemixer") },
    { MODKEY|ShiftMask,	  XK_r,		      spawn,		SHCMD("alacritty --class float-alc -e gotop") },
